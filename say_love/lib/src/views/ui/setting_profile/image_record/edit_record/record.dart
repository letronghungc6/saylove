...
//      dynamic jsonBody = json.decode( utf8.decode(r.data));
      ...
      if(response.statusCode == 200){
        ...
        Navigator.pushReplacement(context, MaterialPageRoute(
            builder: (context) => ImageRecord(media: fileRecord, token: widget.token, id: widget.id, textRecord : textDateCard)));
...
//        tenFile = "/data/user/0/com.example.say_love/cache/file_picker/$dato.m4a";
      ...
      audioRecorder = FlutterAudioRecorder(patho);
