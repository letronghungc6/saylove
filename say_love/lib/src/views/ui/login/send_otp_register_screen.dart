...
class SendOTPRegister extends StatefulWidget {
  SendOTPRegister({@required this.textEmail});
  String textEmail="";
  @override
  _SendOTPRegister createState() => _SendOTPRegister();
}

class _SendOTPRegister extends State<SendOTPRegister> {
  ...
  verifyEmail() async{
    ...
    String url = "http://45.76.151.147:8091/api/auth/register/verify_email";
    ...
    try{
      ...
      if (jsonBody["status_code"] == 200) {
        Navigator.pushReplacement(context, MaterialPageRoute(
            builder: (context)=> LoginScreen(textEmail: textEmail)
        )
        );
      }
