...
import 'package:say_love/src/views/ui/login/register_test_bloc/register_bloc.dart';
...
//  }
  ...
  Widget build(BuildContext context) {
    ...
    final dialogError = StreamBuilder(
      stream: bloc.dialogStream,
        builder: (context, snapshot)=>AlertDialog(
          content: Text(
            snapshot.hasData ? "${snapshot.data}": "Lỗi",
            textAlign: TextAlign.center,
            style: TextStyle(
                color: Colors.black54, fontWeight: FontWeight.bold, fontSize: 15
            ),
...
//    );
      ...
      stream: bloc.emailStream,
        builder: (context, snapshot)=>Container(
          ...
          decoration: BoxDecoration(
              ...
              border: Border.all(
                width: 1,
                color: snapshot.error == "Sai" ? Colors.red : Colors.black26,
              )
          ),
          child: Row(
    ...
    //--------------------------------------------------------------------------------------------------------
    final confirmPassword = StreamBuilder(
...
//          ),
//          onPressed: () {
//            if(bloc.isValidInfo(controllerTextEmail.text, controllerPassword.text, controllerConfirmPassword.text)==false){
//              showDialog(
//                context: context,
//                builder: (BuildContext context) {
//                  return AlertDialog(
...
//    );
    ...
    final register = SizedBox(
      ...
      child: RaisedButton(
          ...
          onPressed: () {
            if(bloc.checkValidEmail(controllerTextEmail.text) == false){
              showDialog(
                context: context,
                builder: (BuildContext context) {
                  return dialogError;
            ...
            else if(bloc.checkValidPassword(controllerPassword.text) == false){
              showDialog(
                context: context,
                builder: (BuildContext context) {
                  return dialogError;
            ...
            else if(bloc.checkValidConfirmPassword(controllerConfirmPassword.text, controllerPassword.text) == false){
              showDialog(
                context: context,
                builder: (BuildContext context) {
                  return dialogError;
